...
begin
	...
	begin
		...
		begin
				...
				if(@confirmado = 1 )
				begin
					exec sp_AddReservation @idTravelLogBook = @idBitacora, @idPersona = @idPerson, @idCabin = @newcabin , @idChannelReservation = @idCanal, @reservationDate = @Fecha, @reservationExpirationDate = @FechadeExpiracion, @reservationStatus = '1'
	...
	begin
				...
				if(@confirmado = 1 )
				begin
					exec sp_AddReservation @idTravelLogBook = @idBitacora, @idPersona = @idPerson, @idCabin = @idCabina , @idChannelReservation = @idCanal, @reservationDate = @Fecha, @reservationExpirationDate = @FechadeExpiracion, @reservationStatus = '1'
					select @existsid = Count(1)
					from  Reservation
